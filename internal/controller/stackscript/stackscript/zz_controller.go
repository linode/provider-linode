...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewNoForkAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["linode_stackscript"],
				...
				tjcontroller.WithNoForkAsyncMetricRecorder(metrics.NewMetricRecorder(v1alpha1.Stackscript_GroupVersionKind, mgr, o.PollInterval)),
			)),
