...
export TERRAFORM_PROVIDER_VERSION := 4.3.0
...
# NOTE: v2 is required, as golangci-lint 1.x refuses to load a module
# declaring a Go version newer than the one it was built with.
...
xpkg.build.provider-linode: do.build.images
# ====================================================================================
# Targets
...
# - UPTEST_CLOUD_CREDENTIALS (optional)
