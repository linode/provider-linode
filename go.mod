...
require (
	...
	github.com/linode/terraform-provider-linode/v2 v2.22.1-0.20240610203944-8aba655976cc
...
replace github.com/linode/linodego v1.35.0 => github.com/linode/linodego v1.35.1-0.20240606150409-fe57a21ddd6f
