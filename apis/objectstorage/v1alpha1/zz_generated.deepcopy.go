...
func (in *KeyObservation) DeepCopyInto(out *KeyObservation) {
	*out = *in
	...
	if in.RegionsDetails != nil {
		in, out := &in.RegionsDetails, &out.RegionsDetails
		*out = make([]RegionsDetailsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RegionsDetailsInitParameters) DeepCopy() *RegionsDetailsInitParameters {
	...
	out := new(RegionsDetailsInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RegionsDetailsObservation) DeepCopy() *RegionsDetailsObservation {
	...
	out := new(RegionsDetailsObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RegionsDetailsParameters) DeepCopy() *RegionsDetailsParameters {
	...
	out := new(RegionsDetailsParameters)
	in.DeepCopyInto(out)
	return out
}
