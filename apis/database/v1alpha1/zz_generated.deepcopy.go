...
func (in *MySQLv2InitParameters) DeepCopyInto(out *MySQLv2InitParameters) {
	*out = *in
	...
	if in.Updates != nil {
		in, out := &in.Updates, &out.Updates
		*out = make([]MySQLv2UpdatesInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MySQLv2Observation) DeepCopyInto(out *MySQLv2Observation) {
	*out = *in
	...
	if in.Updates != nil {
		in, out := &in.Updates, &out.Updates
		*out = make([]MySQLv2UpdatesObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MySQLv2Parameters) DeepCopyInto(out *MySQLv2Parameters) {
	*out = *in
	...
	if in.Updates != nil {
		in, out := &in.Updates, &out.Updates
		*out = make([]MySQLv2UpdatesParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MySQLv2UpdatesInitParameters) DeepCopyInto(out *MySQLv2UpdatesInitParameters) {
	*out = *in
	if in.DayOfWeek != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MySQLv2UpdatesInitParameters.
func (in *MySQLv2UpdatesInitParameters) DeepCopy() *MySQLv2UpdatesInitParameters {
	if in == nil {
		return nil
	}
	out := new(MySQLv2UpdatesInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MySQLv2UpdatesObservation) DeepCopyInto(out *MySQLv2UpdatesObservation) {
	*out = *in
	if in.DayOfWeek != nil {
		in, out := &in.DayOfWeek, &out.DayOfWeek
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MySQLv2UpdatesObservation.
func (in *MySQLv2UpdatesObservation) DeepCopy() *MySQLv2UpdatesObservation {
	if in == nil {
		return nil
	}
	out := new(MySQLv2UpdatesObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MySQLv2UpdatesParameters) DeepCopyInto(out *MySQLv2UpdatesParameters) {
	*out = *in
	if in.DayOfWeek != nil {
		in, out := &in.DayOfWeek, &out.DayOfWeek
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MySQLv2UpdatesParameters.
func (in *MySQLv2UpdatesParameters) DeepCopy() *MySQLv2UpdatesParameters {
	if in == nil {
		return nil
	}
	out := new(MySQLv2UpdatesParameters)
	in.DeepCopyInto(out)
	return out
}
